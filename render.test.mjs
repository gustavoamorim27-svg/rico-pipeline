...
test('all main views render from the source with separated client tiers and pipe priorities',()=>{
  ...
  const context={...core,esc:core.escapeHTML,VaultStore,FirestoreTransport,readLegacyLocal,document,window:{addEventListener(){}},setTimeout,clearTimeout,setInterval,clearInterval,console,crypto};

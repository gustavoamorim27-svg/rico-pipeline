const CACHE='rico-clientes-shell-v3-20260913-1';
const SHELL=['./','./index.html','./styles.css','./app.mjs','./core.mjs','./store.mjs','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
